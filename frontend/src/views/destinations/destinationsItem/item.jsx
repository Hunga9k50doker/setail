...
import { BgSydneyOpera, Destination_img_item_01, Destination_img_item_02 } from "../../../assets/img";
          ...
          .map(
            (item, index) =>
              to_slug(item.title) === slug && (
                <Banner key={index} img={BgSydneyOpera} title={item.title} subTitle="Amazing Tour" description={item.description}></Banner>
              )
          )}
                      ...
                      <div className="content__item">
                        ...
                        <p className="item__description">
                          ...
                          <div className="content__item__img">
                            <div className="col">
                              <img src={Destination_img_item_01} alt="Not found" />
                            </div>
                            <div className="col">
                              <img src={Destination_img_item_02} alt="Not found" />
                            </div>
                          </div>
                          Vero sed sit clita no sit. Eirmod lorem duo et est sit accusam sit, dolor aliquyam diam sit eos. Gubergren.Ipsum sit labore
                          dolores sea aliquyam. Stet stet duo diam eirmod nonumy at invidunt, lorem vero ea consetetur lorem ipsum.
                        </p>
                      </div>
                      <FormDescription />
                      <div className="content__item">
                        <h2 className="item__title">Municipalities</h2>
                        <p className="item__subtitle">Takimata dolor magna diam lorem sed magna est sea invidunt ut. At no lorem accusam.</p>
